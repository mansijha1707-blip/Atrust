...
SCAM_RULES = [
    ...
    (r"account locked|account has been locked",    "text:account_locked",     4),
    (r"locked due to|blocked due to",              "text:account_threat",     4),
    (r"click here|click the link|clicking here",   "text:phishing_link",      4),
    ...
    (r"verify your account|verify your identity",  "text:identity_verify",    4),
    (r"reactivate",                                "text:account_verify",     3),
    (r"rbi|income tax|irdai|trai|narcotics",       "text:impersonation",      5),
    (r"limited time|expires today|act now",        "text:urgency_pressure",   3),
    (r"suspicious activity",                       "text:suspicious_activity",4),
    (r"permanent suspension|permanently suspended","text:permanent_threat",   4),
    (r"avoid suspension|avoid blocking",           "text:threat_language",    3),
]
